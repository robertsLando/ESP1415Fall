...
public class SelectHelperPreference extends DialogPreference {
	...
	private ArrayList<String> mName = new ArrayList<String>(); // we use this
																// for saved
																// datas from
																// database
	private ArrayList<String> mMail = new ArrayList<String>();// we use this for
																// saved datas
																// from database
	private ArrayList<String> mSelectedItem; // we save the index of the
												// selected item
	...
	private AlertDialog mSelectHelper;
	...
	protected Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		mSelectedItem = new ArrayList<String>(); // where we track the selected
													// items
		...
		if (mEntries == null || mEntryValues == null
			...
			Toast.makeText(mContext,
					"You need an Entries Array and an EntriesValue Array",
					Toast.LENGTH_SHORT).show();
			return null;
		}
		// ANDROID DOCUMENTATION: Specify the list array, the items to be
		// selected by default (null for none), and the listener through which
				...
				new DialogInterface.OnMultiChoiceClickListener() {
					...
					public void onClick(DialogInterface dialog, int which,
						...
						if (isChecked) {
							...
							// selected items
							mPreferenceChanged = mSelectedItem
